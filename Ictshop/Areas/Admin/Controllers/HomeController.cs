...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Create()
        {
            ...
            var swtselected = new SelectList(db.Switchs, "Maswitch", "Tenswitch");
            ViewBag.Maswitch = swtselected;
            return View();
        }
        ...
        public ActionResult Edit(int id)
        {
            ...
            ViewBag.Mahang = hangselected;
            var swtselected = new SelectList(db.Switchs, "Maswitch", "Tenswitch", dt.Maswitch);
            ViewBag.Maswitch = swtselected;
           // 
            return View(dt);
        ...
        public ActionResult Edit(Sanpham sanpham)
        {
            try
            {
                ...
                oldItem.Maswitch = sanpham.Maswitch;
                // lưu lại
                db.SaveChanges();
